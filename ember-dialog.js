(function() {
    ...
    var ember$dialog$lib$utils$highest$zindex$$default = function () {
      var $ = Ember.$;
    ...
    var ember$dialog$lib$components$presenter$$computed = Ember.computed;
    var ember$dialog$lib$components$presenter$$observer = Ember.observer;

    var ember$dialog$lib$components$presenter$$Presenter;

    ember$dialog$lib$components$presenter$$Presenter = Ember.Component.extend({
      ...
      */
      ...
      /**
        ...
        @default false
      */
      isActive: ember$dialog$lib$components$presenter$$computed('name', 'dialogManager.active', function() {
      ...
      /**
        ...
        @private
      */
      _visibleDidChange: ember$dialog$lib$components$presenter$$observer('isVisible', function() {
        ...
        // method will not be finished.
         Ember.run.scheduleOnce('afterRender', this, function() {
          ...
          if (!this.get("fixedZIndex")) {
            // Biggest z-index
            zindex = ember$dialog$lib$utils$highest$zindex$$default();
    ...
    if (Ember.libraries) {
      Ember.libraries.registerCoreLibrary('Ember Dialog', ember$dialog$lib$core$$Dialog.VERSION);
    }

    var ember$dialog$lib$core$$default = ember$dialog$lib$core$$Dialog;
    var ember$dialog$lib$system$manager$$Manager;

    var ember$dialog$lib$system$manager$$Service = Ember.Service;
    if (!ember$dialog$lib$system$manager$$Service) {
      ember$dialog$lib$system$manager$$Service = Ember.Object;
    }

    ember$dialog$lib$system$manager$$Manager = ember$dialog$lib$system$manager$$Service.extend(Ember.Evented, {

      forTestingAutoDeploy: "forTestingAutoDeploy",
    ...
    var ember$dialog$lib$system$manager$$default = ember$dialog$lib$system$manager$$Manager;
    function ember$dialog$lib$initializers$manager$$initializeDialogManager(registry) {
      registry.register('dialog:manager', ember$dialog$lib$system$manager$$Manager, { singleton: true });
    ...
    var ember$dialog$lib$initializers$manager$$default = ember$dialog$lib$initializers$manager$$initializeDialogManager;
    function ember$dialog$lib$initializers$presenter$$initializeDialogComponent(registry) {
      registry.register('dialog:presenter', ember$dialog$lib$components$presenter$$Presenter);
    }
    var ember$dialog$lib$initializers$presenter$$default = ember$dialog$lib$initializers$presenter$$initializeDialogComponent;
    function ember$dialog$lib$setup$container$$setupContainer(container, application) {
      ...
      ember$dialog$lib$initializers$manager$$default(container, application);
      ember$dialog$lib$initializers$presenter$$default(container, application);
    }
    var ember$dialog$lib$setup$container$$default = ember$dialog$lib$setup$container$$setupContainer;
    ...
    Ember.onLoad('Ember.Application', function(Application) {
      ...
      Application.initializer({
        name:       "ember-dialog",
        initialize: ember$dialog$lib$setup$container$$default
      });
    ...
    ember$dialog$lib$core$$default.Manager = ember$dialog$lib$system$manager$$Manager;
    ember$dialog$lib$core$$default.Presenter = ember$dialog$lib$components$presenter$$Presenter;

    ember$dialog$lib$core$$default._setupContainer = ember$dialog$lib$setup$container$$default;

    Ember.lookup.Dialog = ember$dialog$lib$core$$default;

    var ember$dialog$lib$main$$default = ember$dialog$lib$core$$default;
